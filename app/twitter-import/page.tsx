...
const STEPS = [
  ...
  { label: 'Paste as the URL', desc: 'Set the Name to "Xtract Import" and paste the copied code as the URL/Location.' },
...
export default function TwitterImportPage() {
  ...
  useEffect(() => {
    const code = BOOKMARKLET_TEMPLATE.replaceAll('__XTRACT_ORIGIN__', window.location.origin)
    ...
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 mb-4">
        ...
        <p className="text-sm text-zinc-400 leading-relaxed">
          ...
          Your credentials never leave your browser. All data goes directly to your local Xtract instance.
        </p>
      </div>
